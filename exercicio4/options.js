...
describe('options', () => {
  ...
  it(`edit product's options name in US language`, async () => {
    ...
    await driver.findElement(By.id('sylius_product_option_translations_en_US_name')).sendKeys('changed');
  ...
  it(`filter options by containing changed word`, async () => {
    ...
    // Find and fill the input with filter word
    await driver.findElement(By.id('criteria_search_value')).sendKeys('changed');
  ...
  it(`create product options with values in each language`, async () => {
    ...
    // Type the option code
    await driver.findElement(By.id('sylius_product_option_code')).sendKeys('test_option');
    ...
    await driver.findElement(By.id("sylius_product_option_values_0_code")).sendKeys('test_size_s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_us_US_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_de_DE_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_fr_FR_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_pl_PL_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_es_ES_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_es_MX_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_pt_PT_value")).sendKeys('s');
    await driver.findElement(By.id("sylius_product_option_values_0_translations_zh_CN_value")).sendKeys('s');
