describe('options', () => {
  ...
  it(`edit product's options name in US language`, () => {
    ...
    cy.get('[id="sylius_product_option_translations_en_US_name"]').clear().type('changed');
  ...
  it(`edit product's options name in PT language`, () => {
    ...
    // Find the input, clear the old value and type a new one
    cy.get('[id="sylius_product_option_translations_pt_PT_name"]').clear().type('calça jeans');
  ...
  it('create product options with values ', () => {
    ...
    // Type the option name in US language
    cy.get('[id="sylius_product_option_translations_en_US_name"]').type('test_option_size_s');
